    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <hr>
                    <h2 class="intro-text text-center">FreeCity
                        <strong>blog</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="img/cat1.jpg" alt="">
                    <h2>FreeCity Cat
                        <br>
                        <small>MARCH 29, 2022</small>
                    </h2>
                    <p>Cat is international pet of FreeCity.</p>
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Read More</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="img/cat2.jpg" alt="">
                    <h2>The Complete Guide to Pet Care
                        <br>
                        <small>MARCH 29, 2022</small>
                    </h2>
                    <p>Only Jennx12 know how to care for cat best ask her for guidance.</p>
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2">Read More</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="img/cat3.jpg" alt="">
                    <h2>Fatentate And Cat
                        <br>
                        <small>MARCH 29, 2022</small>
                    </h2>
                    <p>Fatentate started this cat thing in freecity chat room now cat as take over the world.</p>
